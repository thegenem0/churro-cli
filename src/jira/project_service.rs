...
pub async fn get_projects() -> Result<ProjectResponse, Box<dyn std::error::Error>> {
    ...
    let resp = crate::jira::jira_service::get::<ProjectResponse>(url).await?;
    Ok(resp)
}
...
pub async fn post_project(body: String) -> Result<ProjectResponse, Box<dyn std::error::Error>> {
    ...
    let resp = crate::jira::jira_service::post::<ProjectResponse>(url, body).await?;
    Ok(resp)
}
...
pub async fn put_project(
    ...
    let resp = crate::jira::jira_service::put::<ProjectResponse>(url, body).await?;
    Ok(resp)
}
...
pub async fn delete_project(
    ...
    let resp = crate::jira::jira_service::delete::<ProjectResponse>(url, body).await?;
    Ok(resp)
}
